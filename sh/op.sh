...
git clone -b packages --depth 1 --single-branch https://github.com/keben12345/openwrt-feeds package/xd
git clone -b porxy --depth 1 --single-branch https://github.com/keben12345/openwrt-feeds package/porxy
